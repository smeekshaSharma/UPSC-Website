        ...
        <td>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="resultnotification" HeaderText="resultnotification" 
                        SortExpression="resultnotification" />
                </Columns>
            </asp:GridView>
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                SelectCommand="SELECT [cyear], [eni], [fname], [con], [dob], [cname], [ename], [email], [pname], [resultnotification] FROM [examfinal] WHERE ([eni] = @eni)">
                <SelectParameters>
