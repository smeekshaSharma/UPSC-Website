        ...
        <tr>
          <td><marquee direction="up"height="374px"width="336px"scrollamount="3">
              <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                  DataSourceID="SqlDataSource2" Width="100%" GridLines="None">
                  <Columns>
              ...
              <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                  ...
                  SelectCommand="SELECT [nsub], [docpdf] FROM [news]"></asp:SqlDataSource></marquee> </td>
        </tr>
      </table>
    </div>
    <div id="apDiv7">
...
<noscript>
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="960" height="412">
