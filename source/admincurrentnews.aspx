...
<title>UPSC | Admin Current News</title>
<script runat="server">
...
.style17 {width: 65%; font-size: medium; font-weight: bold; color: #000000; }
...
<div id="apDiv1">
  ...
  <div id="apDiv3">
    <table width="100%" border="0">
      ...
      <tr>
        <td colspan="2" bgcolor="#FFFFFF"><span class="style16">Admin Panel</span></td>
      </tr>
      <tr>
    ...
    <table width="100%" border="0">
      <tr>
        <td colspan="2" class="style12">
            ...
            <asp:Label ID="Label2" runat="server" ForeColor="Blue" Text="Label"></asp:Label>          </td>
        <td colspan="2" bgcolor="#000000" class="style12">
          <asp:LinkButton ID="LinkButton1" runat="server" ForeColor="Black" 
                onclick="LinkButton1_Click">Logout</asp:LinkButton>          </td>
      </tr>
      
      <tr>
        <td colspan="4" class="style3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Admin Current News</td>
      </tr>
      ...
      <tr>
        <td width="41%" class="style11">Current Date</td>
        <td class="style12" colspan="2">          <span class="style16">
            <asp:TextBox ID="T1" runat="server" Height="22px"></asp:TextBox>
           </span></td>
        <td width="13%" class="style12">&nbsp;</td>
      </tr>
      <tr>
        <td class="style13">New Subject</td>
        <td class="style14" colspan="2">          <span class="style16">
            <asp:TextBox ID="T2" runat="server"></asp:TextBox>
           </span></td>
        <td class="style14">
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                ControlToValidate="T2" ErrorMessage="Enter Examination Name"></asp:RequiredFieldValidator>          </td>
      </tr>
      <tr>
        <td class="style44">News Description
        <td colspan="2">          <span class="style16">
            <asp:TextBox ID="T3" runat="server"></asp:TextBox>
           </span></td>
        <td>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                ControlToValidate="T3" ErrorMessage="Date of Exam"></asp:RequiredFieldValidator>          </td>
      </tr>
      <tr>
        <td class="style44">Document Type</td>
        <td colspan="2">          <span class="style16">
            <asp:TextBox ID="T4" runat="server"></asp:TextBox>
           </span></td>
        <td>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                ControlToValidate="T4" ErrorMessage="Duration Exam"></asp:RequiredFieldValidator>          </td>
      </tr>
      
      <tr>
        <td class="style44">Document/ PDF</td>
        <td colspan="2">
            <asp:FileUpload ID="fileuplod1" runat="server" />          </td>
        <td>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
                ControlToValidate="fileuplod1" ErrorMessage="Notification of PDF"></asp:RequiredFieldValidator>          </td>
      </tr>
      <tr>
        <td class="style17">
