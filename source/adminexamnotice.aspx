...
<title>UPSC | Admin Exam Notice</title>
<script runat="server">
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        If T1.Text = "" Or T2.Text = "" Or T4.Text = "" Or fileuplod1.FileName = "" Then
...
.style27 {width: 65%; font-size: medium; font-weight: bold; color: #666666; }
#apDiv9 {
	position:absolute;
	width:80%;
	height:108px;
...
<div id="apDiv1">
  ...
  <div id="apDiv6">
    <table width="100%" height="615" border="0">
      ...
      <tr>
        <td class="style27">Date of Commencement of Examination
      ...
      <tr>
        <td class="style27">Duration of Examination</td>
      ...
      <tr>
        <td class="style27">Last Date for Receipt of Applications</td>
        <td colspan="2">          <span class="style19">
      ...
      <tr>
        <td height="30" class="style27">Notification of PDF</td>
        <td colspan="2">
